...
def main():
    ...
    r_arm1 = Node(base, glm.mat4(), glm.translate((.25,0,0)) * glm.scale((.25,.1,0.)), glm.vec3(1,0,0))
    r_arm2 = Node(r_arm1, glm.mat4(), glm.translate((.25,0,0)) * glm.scale((.25,.1,0.)), glm.vec3(0,1,0))
    l_arm1 = Node(base, glm.mat4(), glm.translate((-.25,0,0)) * glm.scale((.25,.1,0.)), glm.vec3(1,0,0))
    l_arm2 = Node(l_arm1, glm.mat4(), glm.translate((-.25,0,0)) * glm.scale((.25,.1,0.)), glm.vec3(0,1,0))
    ...
    while not glfwWindowShouldClose(window):
        ...
        r_arm1.set_joint_transform(glm.translate((.2,0,.01)) * glm.rotate(t, (0,0,1)))
        r_arm2.set_joint_transform(glm.translate((.5,0,.01)) * glm.rotate(t, (0,0,1)))
        l_arm1.set_joint_transform(glm.translate((-.2,0,.01)) * glm.rotate(-t, (0,0,1)))
        l_arm2.set_joint_transform(glm.translate((-.5,0,.01)) * glm.rotate(-t, (0,0,1)))
        ...
        draw_node(vao_box, r_arm1, P*V, MVP_loc_box, color_loc_box)
        draw_node(vao_box, r_arm2, P*V, MVP_loc_box, color_loc_box)
        draw_node(vao_box, l_arm1, P*V, MVP_loc_box, color_loc_box)
        draw_node(vao_box, l_arm2, P*V, MVP_loc_box, color_loc_box)
