...
def main():
    ...
    glfwWindowHint(GLFW_OPENGL_FORWARD_COMPAT, GL_TRUE)  # Forward Compatible 설정
    #Do not allow legacy Opnegl API calls

    # create a window and OpenGL context
    window = glfwCreateWindow(800,800,'2-second-gl-program',None,None)
    if not window:
        glfwTerminate()
        return
